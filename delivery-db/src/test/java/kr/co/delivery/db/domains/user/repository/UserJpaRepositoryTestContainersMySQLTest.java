...
import kr.co.delivery.db.config.ContainersTestMySQLConfig;
...
@ActiveProfiles("db-testcontainer-mysql-test")
@EnableAutoConfiguration
@ContextConfiguration(classes = {JpaConfig.class})
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE)
@Sql(value = "classpath:test-data.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_CLASS)
@DataJpaTest
class UserJpaRepositoryTestContainersMySQLTest extends ContainersTestMySQLConfig {
