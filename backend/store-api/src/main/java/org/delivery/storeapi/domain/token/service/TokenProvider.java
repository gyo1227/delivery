...
public class TokenProvider {
    ...
    public Authentication getAuthentication(String token) {
        ...
        UserDetails principal = StoreUserSession.builder()
                .id(Long.parseLong(claims.get("storeUserId").toString()))
                .role(StoreUserRole.valueOf(claims.get("storeUserRole").toString()))
                .build();
